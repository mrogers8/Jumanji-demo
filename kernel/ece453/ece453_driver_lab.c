 ...
 *****************************************************************************/
static struct kobj_attribute step_control_attribute = 
	__ATTR(step_control, 0664, ece453_read_step_control, ece453_write_step_control);
